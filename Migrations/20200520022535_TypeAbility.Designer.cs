...
namespace char_creation.Migrations
{
    ...
    [Migration("20200520022535_TypeAbility")]
    partial class TypeAbility
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("char_creation.Models.TypeAbility", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TypeAbility");
                });

            modelBuilder.Entity("char_creation.Models.Ability", b =>
                {
                    b.HasOne("char_creation.Models.TypeAbility", "typeAbility")
                        .WithMany()
                        .HasForeignKey("typeAbilityId");
                });
